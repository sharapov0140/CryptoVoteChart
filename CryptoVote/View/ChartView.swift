...
//                let index = Int(Double(i) * k)
//                points[i] = data[index]
//                dates[i] = convertUnixTimeToDateString(unixTime: dateData[index])
//            }
//            
//            if k < 1 {
//                points[points.count - 1] = data[data.count - 2]
//            }
//            
//            // For layout bubble view
//            let value = points.first ?? 0
//            // Assume you have a method formatCost in a Formatter class
//            Formatter.formatCost(label: priceLabel, value: value, maximumFractionDigits: value > 1.0 ? 2 : 5)
//            
//            setNeedsDisplay()
//        }
